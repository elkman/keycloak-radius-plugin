...
***requirements***: [keycloak 26.7.3](https://github.com/keycloak/keycloak/releases/download/26.7.3/keycloak-26.7.3.zip)
```bash
...
```
where
- **KEYCLOAK_PATH** - Path where you are unpacked keycloak-26.7.3.zip [(you can use RADIUS_CONFIG_PATH instead of KEYCLOAK_PATH)](#environment-variables)
